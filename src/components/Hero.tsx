            ...
            <div>
              ...
              <div style={{ display: "flex", gap: 12 }}>
                {[
                  ...
                  <a key={s.label} href="#" aria-label={s.label} style={{ width: 40, height: 40, borderRadius: 10, border: "1px solid var(--border)", display: "flex", alignItems: "center", justifyContent: "center", color: "var(--dim)", background: "rgba(255,255,255,0.02)", transition: "color .2s, border-color .2s, background .2s" }}
